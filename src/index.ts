...
import {Composibility, Reverse, MapReturns, MapParams, Tail, Head} from "./utils/utilityTypes"
...
function objStr(obj: {str: string, num:number, bool: boolean, numArr: number[]}) {
  console.log(obj)
...
type test3c = [typeof strNum, typeof numBool, typeof boolArrStr, typeof arrStrObj]
type test3d = [typeof strNum, typeof numBool, typeof boolArrStr, typeof arrStrObj, typeof objStr]
